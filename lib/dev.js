...
var argv = yargs.usage("用法: QianYuan dev [options]").option("env", {
  alias: "e",
  type: "string",
  description: "用于指定路由环境",
  "default": "test"
}).help("h").argv;
export default function dev(_x) {
  return _dev.apply(this, arguments);
}
function _dev() {
  _dev = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee(argv) {
    var paths, dihogConfig, config, compiler, devServerOptions, server;
        ...
        case 0:
          ...
          if (dihogConfig !== false) {
            ...
            if (config !== false) {
              ...
              devServerOptions = Object.assign({}, config.devServer);
